...
class ItemFull extends Component {
  ...
  render() {
    ...
    return (
      <div className="ItemFull" onClick={this.props.onClose} style={{display: this.state.closed ? 'none' : 'block'}}>
      <div className="item-panel">
        ...
        <h5 id="itemLocation">Location: {itemFetch.location}, {itemFetch.locationState}</h5>

        <h5 id="itemCondition">Condition: {itemFetch.condition} </h5>
        <div id="itemDescription">
          <h5 >Description: </h5><p>{itemFetch.description}</p>
        </div>
        <div id="itemSubmittedby">
          <h5>Submitted By: </h5> <p> {itemFetch.submittedby}</p><br />
        ...
        }
        {
          ...
          (itemFetch.cellmodel !== '' && itemFetch.cellmodel !== null && itemFetch.cellmodel !== undefined) ? (
            ...
            <div id="itemCellModel">
              <h5>Cell Model:</h5> {itemFetch.cellmodel}<br />
            </div>
            </>
          ) : (null)
        }
